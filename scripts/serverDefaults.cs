...
$Host::GameName = "Tribes 2 Construction";
$Host::Info = "This is a Tribes 2 Construction Server.";
...
$Host::AdminPassword = "** CHANGE THIS **";
$Host::ClassicSuperAdminPassword = "** CHANGE ME **";
...
$Host::ClassicAutoPWPassword = "** CHANGE IT **";            // $Host::Password changed to this if $Host::ClassicAutoPWEnabled is enabled
